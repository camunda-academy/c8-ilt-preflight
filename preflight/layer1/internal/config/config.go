...
type Config struct {
	...
	TrainingGroupID string // --training-group (opaque label only — never a customer name)
...
func Parse(argv []string) (*Config, error) {
	...
	trainingGroup := fs.String("training-group", "", "opaque training-group/engagement label for the result JSON — NEVER a customer name")
