 ...
 *    network mode. This probe does that -- verified live: no token acquired
 ...
 *    documents in RUNBOOK that a real Java app needs -Dhttps.proxyHost/Port
...
public final class SdkProbe {
  private static final String USAGE =
      "Layer 2 SDK-snippet confirmation -- Java.\n"
          ...
          + "See the RUNBOOK's Java section for env vars.";
  ...
  private static int run(String[] args) {
      ...
      System.out.println(
          Shared.fragment(
              ...
              "your CAMUNDA_REST_ADDRESS is Camunda Console's copy-paste form (stray ':443' path "
                  + "segment). The real Java SDK does NOT tolerate it (confirmed live: it yields a "
    ...
    if (!isFull) {
      ...
      // caCertificatePath(), which we don't wire here). Confirmed live: with
        ...
        System.out.println(
            Shared.fragment(
                ...
                "CAMUNDA_CA_CERTIFICATE_PATH is set, but the real SDK's OAuth token-fetch client does not "
                    ...
                    + "default SSLContext also honors (see RUNBOOK)."));
      }
